...
var weatherAPI = function (address) {
...
var latitudeText = document.querySelector('.weather-latitude');
var longitudeText = document.querySelector('.weather-longitude');
var locationText = document.querySelector('.weather-location');
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, weatherAPI(searchValue.value)];
            case 1:
                data = _a.sent();
                if (data.error) {
                    console.log(data.error);
